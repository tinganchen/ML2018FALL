...
# model = keras.models.load_model('savings/s2s_no_cap_inputs.h5') # 'savings/s2s.h5'
model = keras.models.load_model('savings/s2s_no_cap_inputs_epoch_3.h5')

# (b) Predict
pred_words = model.predict(encoder_input_data)
...
'''
save_csv(ans, 'savings/seq2seq_no_cap_input_output.csv') # 'savings/s2s.h5'

print('The output file is saved. \nPlease check it in the path, "savings/seq2seq_no_cap_input_output.csv".')

# Model: s2s_no_cap_inputs.h5
# epoch = 10
# loss: 1.3377 - acc: 0.6866 - val_loss: 1.9197 - val_acc: 0.6566 [0.212]
'''

save_csv(ans, 'savings/seq2seq_no_cap_input_output_epoch_3.csv') # 'savings/s2s.h5'

print('The output file is saved. \nPlease check it in the path, "savings/seq2seq_no_cap_input_output_epoch_3.csv".')

# Model: s2s_no_cap_inputs_epoch_3.h5
# epoch = 3
# loss: 1.8219 - acc: 0.6686 - val_loss: 1.8903 - val_acc: 0.6674 [0.212]